...
from . import User, Recipe, Photo, Bookmark, Rating, QuantifiedIngredient, Step, Ingredient

# TESTS INCOMPLETE - they don't work yet
class TestModels(unittest.TestCase):
    ...
    def test_photo_creation(self):
        ...
        for i in range(3):
            photo = Photo(file_extension='jpg', user_id=user.id, recipe_id=recipe.id)
        ...
        for saved_photo, i in zip(saved_photos, range(1, 4)):
            self.assertEqual(saved_photo.file_extension, 'jpg')
